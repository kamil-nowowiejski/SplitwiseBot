...
namespace SplitwiseBot
{
	...
	public class Startup
	{
		...
		{
			services.AddMvc();
			services.AddBot<SplitwiseBot>(options => ConfigureBot(options, services));
		...
		{
			var hostedAddress = Configuration[ConfigurationKeys.HostedAddress];
			string oAuthCallbackUrl = new Uri(new Uri(hostedAddress), "oauth").ToString();

			return new SplitwiseClientBuilder(
				Configuration[ConfigurationKeys.SplitwiseConsumerKey],
				Configuration[ConfigurationKeys.SplitwiseConsumerSecret],
				SplitwiseApi.SplitwiseBaseUrl,
				oAuthCallbackUrl,
				SplitwiseApi.GetRequestTokenMethod,
				SplitwiseApi.GetAccessTokenMethod,
				SplitwiseApi.AuthorizationUrl);
	}
